	...
	$.noty.themes.default = {
		...
		style: function() {
			...
			switch (this.options.layout.name) {
				case 'top':
					this.$bar.css({
						borderRadius: '2px',
						border: '1px solid',
						boxShadow: "rgba(0, 0, 0, 0.0980392) 0px 2px 4px"
					});
				break;
			...
			switch (this.options.type) {
				...
				case 'error':
					this.$bar.css({backgroundColor: 'rgb(255, 129, 129)', borderColor: 'rgb(226, 83, 83)', color: '#FFF'});
					this.$message.css({fontWeight: 'bold'}); 
					this.$buttons.css({borderTop: '1px solid rgb(226, 83, 83)'}); break;
				case 'information':
					this.$bar.css({backgroundColor: '#57B7E2', borderColor: '#0B90C4', color: '#FFF'}); 
					this.$buttons.css({borderTop: '1px solid #0B90C4'}); break;
				case 'success':
					this.$bar.css({backgroundColor: 'rgb(188, 245, 188)', borderColor: 'rgb(124, 221, 119)', color: 'rgb(0, 100, 0)'}); 
