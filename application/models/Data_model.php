...
class Data_model extends CI_Model {
    ...
    public function buscar_productos($strBusqueda, $camposBusqueda, $limite) {
        ...
        $sqlComun = "SELECT p.Descripcion AS Producto, t.Nombre AS Tipo, c.Nombre AS Categoría, sc.Nombre AS SubCategoría, e.Nombre as Empresa, p.IdEstadoCertificacion
                                FROM producto p
